...
Public Class FacturacionElectronica
    ...
    Friend Sub StartProcess(Items As Object)
        ...
        Try
            ...
            sWSResponse = oAppService.OnlineGeneration(My.Settings.CompanyTaxCode, My.Settings.PPL_UserSoap, My.Settings.PPL_PasswordSoap, oDocText.Text, My.Settings.PPL_TipoFolioSoap, True, My.Settings.PPL_TipoRetornoSoap, True)
        ...
        Catch ex As Exception
            ...
            MailObject.Add(oMailItems.Subject & " (PROCESS WITH ERROR)")
            MailObject.Add(ex.Message & "<br><br>" & ex.StackTrace.ToString & "<br><br>" & oMailItems.HTMLBody & "<br><br>" & sWSResponse & "<br><br>")
            ...
            If bReply Then
                If Not bLocalInvoice Or My.Settings.ReplyAllMails Then
                    If My.Settings.CCMailAddress <> "" Then
                        oMailItems.CC = My.Settings.CCMailAddress
                    End If
                    If My.Settings.BCCMailAddress <> "" Then
                        oMailItems.BCC = My.Settings.BCCMailAddress
                    End If
                    ReplyMessage(oMailItems, FileXml)
                End If
            End If
        End If
    End Sub
