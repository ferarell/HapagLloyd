...
Public Class NotificationsWcfForm
    ...
    Dim oAppService As New AppService.HapagLloydServiceTestClient
    ...
    Private Sub bbiImportContacts_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbiImportContacts.ItemClick
        ...
        SplashScreenManager.Default.SetWaitFormDescription("Insert New Contacts")
        ...
        'Next
        oAppService.UpdatingUsingTableAsParameter("upContactsByTable_Insert", Nothing, Nothing, dtSource)
        SplashScreenManager.CloseForm(False)
