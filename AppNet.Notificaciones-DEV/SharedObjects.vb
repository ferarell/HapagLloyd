...
Module SharedObjects
    ...
    Friend Function LoadExcelWCH(ByVal FileName As String, ByRef Hoja As String, HeaderPosition As Integer, Condition As String) As DataTable
        ...
        Using connection As New System.Data.OleDb.OleDbConnection(ExcelConnectionString)
            Try
                ...
                HeaderPosition -= 1
                For r = HeaderPosition To dsResult.Tables(0).Rows.Count - 1
                    If r = HeaderPosition Then
                        dtResult = CopyDataTable(dsResult.Tables(0))
                        Continue For
                    End If
                    dtResult.Rows.Add()
    ...
    Function CopyDataTable(OriginalTable As DataTable) As DataTable
        Dim dtResult As New DataTable
        For c = 0 To OriginalTable.Columns.Count - 1
            If Not IsDBNull(OriginalTable.Rows(0)(c)) Then
                dtResult.Columns.Add(OriginalTable.Rows(0)(c), OriginalTable.Columns(c).DataType)
            End If
        Next
        Return dtResult
    End Function
