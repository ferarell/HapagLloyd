...
Public Class NotificationsForm
    ...
    Private Sub bbiLoadContacts_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbiLoadContacts.ItemClick
        ...
        dtContacts.Clear()
        dtContacts = ExecuteAccessQuery("select distinct * from ContactsQry where Regime='" & sRegime & "'").Tables(0)
        ...
        dtBlackList = ExecuteAccessQuery("select distinct * from BlackList where Regime='" & sRegime & "'").Tables(0)
    ...
    Private Sub bbiImportContacts_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles bbiImportContacts.ItemClick
        ...
        ExecuteAccessQuery("delete from Contacts where Regime='" & sRegime & "'")
        For r = 0 To dtSource.Rows.Count - 1
    ...
    Friend Function LoadBlackListTextFile(FileName As String) As DataTable
        ...
        Try
            ...
            ExecuteAccessNonQuery("delete from BlackList where Regime='" & sRegime & "'")
            ...
            Using sr As New StreamReader(FileName)
                ...
                For i As Integer = 0 To lines.Count - 1
                    ...
                    If ExecuteAccessQuery("select * from Contacts where MatchCode = '" & sMatchCode & "' and Regime='" & sRegime & "'").Tables(0).Rows.Count = 0 Then
                        Continue For
                    End If
                    dtResult.Rows.Add()
