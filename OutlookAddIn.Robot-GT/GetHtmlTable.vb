...
Public Class GetHtmlTable
    ...
    Friend Function GenerateTable(dtSource As DataTable) As String
        ...
        For col = 0 To dtSource.Columns.Count - 1
            Msg.AppendText("<td width=auto valign=top style='width:auto;border:solid windowtext 1.0pt;")
        ...
        For r = 0 To dtSource.Rows.Count - 1
            ...
            For c = 0 To dtSource.Columns.Count - 1
                ...
                End If
                'DataColumn
                Msg.AppendText("<td align=center width=auto valign=top style='width:auto;font-size:10.0pt;font-family:""Tahoma"",sans-serif'>")
                If dtSource.Columns(c).DataType.Name.Contains("Date") Then
                    If Not IsDBNull(dtSource.Rows(r)(c)) Then
