    ...
    Friend Sub StartProcess(Items As Object)
        ...
        Try
            For r = 26 To iRows
                ...
                dtPurchaseOrderControl.Rows(iPos)(4) = sPort
        ...
        sVendorContact = GetVendorContact(ProcessCode, VendorCode, sPort)
