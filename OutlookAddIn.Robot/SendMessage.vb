...
Public Class SendMessage
    ...
    Friend Sub Response(oMailItem As Outlook.MailItem, aFiles As ArrayList, SubjectResponse As String)
        ...
        oNewMessage.Subject = IIf(Not SubjectResponse Is Nothing, SubjectResponse, oMailItem.Subject & IIf(oMailItem.Subject.Contains("(RESPUESTA)"), "", " (RESPUESTA)"))
