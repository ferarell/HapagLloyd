...
Public Class HapagLloydServiceTest
    Implements IHapagLloydServiceTest

    Public Function ExecuteSQL(ByVal QueryString As String) As DataSet Implements IHapagLloydServiceTest.ExecuteSQL
        Dim dsResult As New DataSet
        Dim oDataAccess As New DataAccessTest
        dsResult = oDataAccess.ExecuteSQL(QueryString)
        Return dsResult
    End Function

    Public Function ExecuteSQLNonQuery(ByVal QueryString As String) As ArrayList Implements IHapagLloydServiceTest.ExecuteSQLNonQuery
    ...
    Public Function UpdateTableWithBulkCopy(ByVal Table As String, ByVal dtSource As DataTable, ByVal ProcessType As String) As ArrayList Implements IHapagLloydServiceTest.UpdateTableWithBulkCopy
        Dim aResult As New ArrayList
        Dim sNroVoucher As String = ""
        aResult.AddRange({1, ""})
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
    ...
    Public Function UpdatingUsingTableAsParameter(ByVal StoreProcedure As String, ByVal Params As ArrayList, ByVal Values As ArrayList, ByVal dtSource As DataTable) As ArrayList Implements IHapagLloydServiceTest.UpdatingUsingTableAsParameter
        Dim aResult As New ArrayList
        Dim sNroVoucher As String = ""
        aResult.AddRange({1, ""})
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
    ...
    Public Function CustomStoredProcedureExecution(ByVal StoreProcedure As String, ByVal ValueList As ArrayList, ByVal dtSource As DataTable) As ArrayList Implements IHapagLloydServiceTest.CustomStoredProcedureExecution
        Dim aResult As New ArrayList
        Dim sNroVoucher As String = ""
        aResult.AddRange({1, ""})
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
...
#Region "Notificador"
    ...
    Public Function InsertContacts(ByVal aSource As ArrayList) As Boolean Implements IHapagLloydServiceTest.InsertContacts
    ...
    Public Function InsertBlackList(ByVal aSource As ArrayList) As Boolean Implements IHapagLloydServiceTest.InsertBlackList
        Dim bResult As Boolean = True
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
            Dim Command As New SqlCommand
    ...
    Public Function InsertPartners(ByVal dtSource As DataTable) As Boolean Implements IHapagLloydServiceTest.InsertPartners
        Dim bResult As Boolean = True
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
            Dim Command As New SqlCommand
...
#Region "T-CHECK"
    ...
    Public Function InserColdTreatment(ByVal dtSource As DataTable) As Boolean Implements IHapagLloydServiceTest.InsertColdTreatment
        Dim bResult As Boolean = True
    ...
    Public Function UpdateColdTreatment(ByVal dtSource As DataTable) As Boolean Implements IHapagLloydServiceTest.UpdateColdTreatment
        Dim bResult As Boolean = True
        Dim aSource As DataRow = dtSource.Rows(0)
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
    ...
    Public Function DeleteColdTreatment(ByVal aSource As ArrayList) As Boolean Implements IHapagLloydServiceTest.DeleteColdTreatment
        Dim bResult As Boolean = True
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
            Dim Command As New SqlCommand
    ...
    Public Function InsertColdTreatmentEvents(ByVal aSource As ArrayList) As Boolean Implements IHapagLloydServiceTest.InsertColdTreatmentEvents
        Dim bResult As Boolean = True
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
            Dim Command As New SqlCommand
    ...
    Public Function DeleteColdTreatmentEvents(ByVal aSource As ArrayList) As Boolean Implements IHapagLloydServiceTest.DeleteColdTreatmentEvents
        Dim bResult As Boolean = True
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
            Dim Command As New SqlCommand
    ...
    Public Function InsertColdTreatmentReadings(ByVal aSource As ArrayList) As Boolean Implements IHapagLloydServiceTest.InsertColdTreatmentReadings
        Dim bResult As Boolean = True
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
            Dim Command As New SqlCommand
    ...
    Public Function DeleteColdTreatmentReadings(ByVal aSource As ArrayList) As Boolean Implements IHapagLloydServiceTest.DeleteColdTreatmentReadings
        Dim bResult As Boolean = True
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
            Dim Command As New SqlCommand
    ...
    Public Function InsertScheduleVoyage(ByVal dtSource As DataTable) As Boolean Implements IHapagLloydServiceTest.InsertScheduleVoyage
        Dim bResult As Boolean = True
        Dim aSource As DataRow = dtSource.Rows(0)
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
...
#Region "REEFER SALES"
    Public Function InsertReeferDataMaster(ByVal dtSource As DataTable) As Boolean Implements IHapagLloydServiceTest.InsertReeferDataMaster
        Dim bResult As Boolean = True
        Dim aSource As DataRow = dtSource.Rows(0)
        Using connection As New SqlConnection(ConfigurationManager.AppSettings("dbSolutionTest"))
            connection.Open()
