...
Public Class GraphicTrendWcfForm
    ...
    Private Sub GraphicTrendForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        bar5.Visible = False
        Try
            dtResult = oAppService.ExecuteSQL("select CT_DATE AS C1, CT_TIME AS C2, CT_USDA1 AS C3, CT_USDA2 AS C4, CT_USDA3 AS C5 from tck.ColdTreatmentReadings where [BOOKING]='" & pBooking & "' and [CONTAINER] = '" & pContainer & "'").Tables(0)
